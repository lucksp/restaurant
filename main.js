...
var drinkArray = [];
var DrinkItem = function(name, desription, price, ingredients, vegan, glutenFree, citrusFree) {
	this.name = name;
...
var plateArray = [];
var FoodPlate = function(name, desription, price, ingredients, vegan, glutenFree, citrusFree) {
...
var Restaurant = function(name, address, desription, menu) {
...
angular.module('RestaurantApp')
	.controller('controlerRestaurant', ['$scope', 'factoryRestInfo', function($scope, factoryRestInfo) {
